    ...
    <div className="w-full">
      ...
      <div className="bg-fuchsia-50 border border-fuchsia-200 rounded-lg p-4">
        <div className="flex items-start">
          <svg className="w-5 h-5 text-fuchsia-600 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
          </svg>
          <div>
            <h4 className="text-sm font-medium text-fuchsia-800 mb-1">Demo Mode</h4>
            <p className="text-sm text-fuchsia-700">
              This is a demonstration. No real bank connection will be made. 
              Use credentials <span className="font-mono bg-fuchsia-100 px-1 rounded">demo/demo</span> when prompted.
            </p>
          </div>
        </div>
      </div>
