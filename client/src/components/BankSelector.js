        ...
        {banks.sort((a, b) => a.priority - b.priority).map((bank) => (
          ...
          >
            ...
            <div className="text-center">
              <div className={`w-16 h-16 ${bank.id === 'sparkasse' ? 'bg-red-600' : bank.id === 'deutsche-bank' ? 'bg-blue-800' : 'bg-blue-100'} rounded-full flex items-center justify-center mx-auto mb-4`}>
                {bank.id === 'sparkasse' ? (
