        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mt-8">
            ...
            <div className="relative">
              <select 
                id="destination"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
          ...
          <div className="flex items-center mt-6">
            ...
            />
            <label htmlFor="sessionTan" className="ml-2 text-sm text-gray-700">
